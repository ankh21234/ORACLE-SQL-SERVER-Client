...
{
    public partial class SQLServerDllIndex : Form
    {
        ...
        private void refreshInitialize()
        {
            ...
            try
            {
                ...
                query = new StreamReader(_assembly.GetManifestResourceStream("ORACLE_SQL_SERVER_Client.Resources.DDL_Extractor_Index_Proc.txt")).ReadToEnd();
            }
            catch
            {
